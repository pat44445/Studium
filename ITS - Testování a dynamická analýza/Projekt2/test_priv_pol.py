...
class TestReg2():
  ...
  @When('nedal souhlas s přijmutím "Privacy Policy"')
  def test_reg2(self):
        ...
        self.driver.find_element(By.ID, "input-email").send_keys("kol897@vm.cpm")
        ...
        if self.driver.find_element(By.NAME, "agree").is_selected():
            self.driver.find_element(By.NAME, "agree").click()


  @Then('Ukáže se zpráva "Warning: You must agree to the Privacy Policy!"')
  def assertion(self):
        assert self.driver.find_element(By.CSS_SELECTOR, ".alert").text == "Warning: You must agree to the Privacy Policy!"
